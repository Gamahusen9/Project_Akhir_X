...
<body>
    <div class="content">
        ...
        <button><a style="text-decoration: none;" href="acer3.php">Selanjutnya</a></button>
        <button class="kembali"><a style="text-decoration: none;" href="acer.php">Kembali</a></button>
    </div>
    <h1>
        ACER
    </h1>
