    ...
    <div class="content">
        <div class="bunglay">
            ...
            ?>
                            <div class="rusak">
                                <div class="card">
                                    <img src="img/20230618_101801.png" alt="">
                                    <div class="text">
                                        <em>no laptop : &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <?= $laptop["no"] ?></em>
                        ...
                        <?php } else { ?>
                            <a style="text-decoration: none;" href="konfirmasi.php?id=<?= $laptop["id"] ?>">
                                <div class="cardlap">
                                    <div class="card">
                                        <img src="img/menlap.png" alt="">
                                        <div class="text">
                                            <p>no laptop : &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <?= $laptop["no"] ?></p>
        ...
        <button><a style="text-decoration: none;" href="asus3.php">Selanjutnya</a></button>
        <button class="kembali"><a style="text-decoration: none;" href="asus.php">Kembali</a></button>
    </div>
    <h1>
        ASUS
    </h1>
