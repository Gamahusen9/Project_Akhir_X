...
<body>
    <div class="content">
        ...
        <button><a style="text-decoration: none;" href="lenovo3.php">Selanjutnya</a></button>
        <button class="kembali"><a style="text-decoration: none;" href="lenovo.php">Kembali</a></button>
    </div>
    <h1>
        LENOVO
    </h1>
